    ...
    def display_content(content)
      ...
      content_html = parsed_content['blocks'].map do |block|
        ...
        when 'image'
          ...
          image_html = content_tag(:figure, class: container_class) do
            concat image_tag(url, alt: caption, class: image_class)
            concat content_tag(:figcaption, caption.to_s.html_safe, class: "centered-content")
          end
