...
Element.prototype.matches || (Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector || function(s2) {
  const e = (this.document || this.ownerDocument).querySelectorAll(s2);
  let t = e.length;
...
Element.prototype.scrollIntoViewIfNeeded || (Element.prototype.scrollIntoViewIfNeeded = function(s2) {
  ...
  const e = this.parentNode, t = window.getComputedStyle(e, null), o3 = parseInt(t.getPropertyValue("border-top-width")), i2 = parseInt(t.getPropertyValue("border-left-width")), n = this.offsetTop - e.offsetTop < e.scrollTop, r = this.offsetTop - e.offsetTop + this.clientHeight - o3 > e.scrollTop + e.clientHeight, a4 = this.offsetLeft - e.offsetLeft < e.scrollLeft, l3 = this.offsetLeft - e.offsetLeft + this.clientWidth - i2 > e.scrollLeft + e.clientWidth, c2 = n && !r;
  (n || r) && s2 && (e.scrollTop = this.offsetTop - e.offsetTop - e.clientHeight / 2 - o3 + this.clientHeight / 2), (a4 || l3) && s2 && (e.scrollLeft = this.offsetLeft - e.offsetLeft - e.clientWidth / 2 - i2 + this.clientWidth / 2), (n || r || a4 || l3) && !s2 && this.scrollIntoView(c2);
});
...
var At = (s2 = 21) => crypto.getRandomValues(new Uint8Array(s2)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
...
function be(s2, e, t = "log", o3, i2 = "color: inherit") {
  ...
  o3 && r.push(o3);
  const a4 = "Editor.js 2.28.2", l3 = `line-height: 1em;
            color: #006FEA;
  ...
  s2 && (n ? (r.unshift(l3, i2), e = `%c${a4}%c ${e}`) : e = `( ${a4} )${e}`);
  try {
...
async function Dt(s2, e = () => {
  ...
  return s2.reduce(async (i2, n) => (await i2, o3(n, e, t)), Promise.resolve());
}
function st(s2) {
...
function re(s2, e) {
  return function() {
    ...
    window.setTimeout(() => s2.apply(t, o3), e);
  };
}
function Pt(s2) {
...
function Ht(s2, e, t) {
  ...
  return (...i2) => {
    const n = this, r = () => {
      o3 = null, t || s2.apply(n, i2);
    }, a4 = t && !o3;
    window.clearTimeout(o3), o3 = window.setTimeout(r, e), a4 && s2.apply(n, i2);
  };
}
function Ce(s2, e, t = void 0) {
  let o3, i2, n, r = null, a4 = 0;
  t || (t = {});
  const l3 = function() {
    a4 = t.leading === false ? 0 : Date.now(), r = null, n = s2.apply(o3, i2), r || (o3 = i2 = null);
  };
  return function() {
    const c2 = Date.now();
    !a4 && t.leading === false && (a4 = c2);
    const u2 = e - (c2 - a4);
    return o3 = this, i2 = arguments, u2 <= 0 || u2 > e ? (r && (clearTimeout(r), r = null), a4 = c2, n = s2.apply(o3, i2), r || (o3 = i2 = null)) : !r && t.trailing !== false && (r = setTimeout(l3, u2)), n;
  };
}
function jt() {
  const s2 = {
    ...
    x11: false,
    linux: false
  }, e = Object.keys(s2).find((t) => window.navigator.appVersion.toLowerCase().indexOf(t) !== -1);
  return e && (s2[e] = true), s2;
}
function ae(s2) {
...
function Se(s2, ...e) {
  ...
  if (z(s2) && z(t))
    for (const o3 in t)
      z(t[o3]) ? (s2[o3] || Object.assign(s2, { [o3]: {} }), Se(s2[o3], t[o3])) : Object.assign(s2, { [o3]: t[o3] });
  return Se(s2, ...e);
}
function Re(s2) {
  const e = jt();
  return s2 = s2.replace(/shift/gi, "\u21E7").replace(/backspace/gi, "\u232B").replace(/enter/gi, "\u23CE").replace(/up/gi, "\u2191").replace(/left/gi, "\u2192").replace(/down/gi, "\u2193").replace(/right/gi, "\u2190").replace(/escape/gi, "\u238B").replace(/insert/gi, "Ins").replace(/delete/gi, "\u2421").replace(/\+/gi, " + "), e.mac ? s2 = s2.replace(/ctrl|cmd/gi, "\u2318").replace(/alt/gi, "\u2325") : s2 = s2.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN"), s2;
}
function zt(s2) {
  try {
...
function Yt(s2, e) {
  const t = Array.isArray(s2) || z(s2), o3 = Array.isArray(e) || z(e);
  return t || o3 ? JSON.stringify(s2) === JSON.stringify(e) : s2 === e;
}
var d = class _d {
  /**
...
var ie = class {
  ...
  static getNamespace(s2) {
    return s2.split(".").reduce((t, o3) => !t || !Object.keys(t).length ? {} : t[o3], ie.currentDictionary);
  }
};
var $2 = ie;
$2.currentDictionary = at;
...
var De = class {
  ...
  off(e, t, o3, i2) {
    ...
    n.forEach((r, a4) => {
      const l3 = this.allListeners.indexOf(n[a4]);
      l3 > -1 && (this.allListeners.splice(l3, 1), r.element.removeEventListener(r.eventType, r.handler, r.options));
    });
  }
  /**
...
var m2 = class _m {
  ...
  findParentTag(e, t, o3 = 10) {
    ...
    return !i2 || !i2.anchorNode || !i2.focusNode ? null : ([
      ...
      let l3 = o3;
      for (; l3 > 0 && a4.parentNode && !(a4.tagName === e && (n = a4, t && a4.classList && !a4.classList.contains(t) && (n = null), n)); )
        a4 = a4.parentNode, l3--;
    }), n);
  }
  /**
...
function Zt(s2, e) {
  const { type: t, target: o3, addedNodes: i2, removedNodes: n } = s2;
  if (o3 === e)
    return true;
  if (["characterData", "attributes"].includes(t)) {
    const l3 = o3.nodeType === Node.TEXT_NODE ? o3.parentNode : o3;
    return e.contains(l3);
  }
  const r = Array.from(i2).some((l3) => e.contains(l3)), a4 = Array.from(n).some((l3) => e.contains(l3));
  return r || a4;
}
...
function Je(s2, e) {
  return s2.mergeable && s2.name === e.name;
}
function Gt(s2, e) {
  const t = e == null ? void 0 : e.export;
  return D(t) ? t(s2) : J(t) ? s2[t] : (t !== void 0 && L("Conversion \xABexport\xBB property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function Jt(s2, e) {
...
var F = class _F extends we {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      const c2 = l3 === void 0, u2 = l3 instanceof InputEvent;
      !c2 && !u2 && this.detectToolRootChange(l3);
      let h3;
      c2 || u2 ? h3 = true : h3 = !(l3.length > 0 && l3.every((k) => {
    ...
    }, this.name = o3.name, this.id = e, this.settings = o3.settings, this.config = o3.settings.config || {}, this.api = i2, this.editorEventBus = a4 || null, this.blockAPI = new ee(this), this.tool = o3, this.toolInstance = o3.create(t, this.blockAPI, n), this.tunes = o3.tunes, this.composeTunes(r), this.holder = this.compose(), window.requestIdleCallback(() => {
  ...
  set selected(e) {
    ...
    const t = e === true && m2.isRangeInsideContainer(this.holder), o3 = e === false && m2.isFakeCursorInsideContainer(this.holder);
    (t || o3) && ((i2 = this.editorEventBus) == null || i2.emit(dt, { state: e }), t ? m2.addFakeCursor() : m2.removeFakeCursor(this.holder), (n = this.editorEventBus) == null || n.emit(ht, { state: e }));
  }
  /**
    ...
    [
      ...
      if (D(r.save))
        try {
          ...
          L(`Tune ${r.constructor.name} save method throws an Error %o`, "warn", a4);
        }
    });
   ...
   */
  updateCurrentInput() {
    this.currentInput = d.isNativeInput(document.activeElement) || !m2.anchorNode ? document.activeElement : m2.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
...
var Qt = class extends C {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o3 = {}, i2, n, r, a4) => {
      ...
      if (!r)
        throw new Error(`Block with id "${e}" not found`);
      const a4 = n.blockTools.get(r.name), l3 = n.blockTools.get(t);
      if (!l3)
        throw new Error(`Block Tool with type "${t}" not found`);
      const c2 = ((h3 = a4 == null ? void 0 : a4.conversionConfig) == null ? void 0 : h3.export) !== void 0, u2 = ((f = l3.conversionConfig) == null ? void 0 : f.import) !== void 0;
      if (c2 && u2)
        i2.convert(r, t, o3);
      else {
        const k = [
...
(function(s2, e) {
  (function(t, o3) {
    ...
    return function(t) {
      ...
      return i2.m = t, i2.c = o3, i2.d = function(n, r, a4) {
        i2.o(n, r) || Object.defineProperty(n, r, { enumerable: true, get: a4 });
      }, i2.r = function(n) {
        ...
        if (i2.r(a4), Object.defineProperty(a4, "default", { enumerable: true, value: n }), 2 & r && typeof n != "string")
          for (var l3 in n)
            i2.d(a4, l3, function(c2) {
              return n[c2];
            }.bind(null, l3));
        return a4;
      }, i2.n = function(n) {
      ...
      */
      t.exports = function() {
        var n = i2(6), r = "cdx-notify--bounce-in", a4 = null;
        return { show: function(l3) {
          if (l3.message) {
            (function() {
              if (a4)
                return true;
              a4 = n.getWrapper(), document.body.appendChild(a4);
            })();
            var c2 = null, u2 = l3.time || 8e3;
            switch (l3.type) {
              case "confirm":
                c2 = n.confirm(l3);
                break;
              case "prompt":
                ...
                break;
              default:
                c2 = n.alert(l3), window.setTimeout(function() {
                  c2.remove();
                }, u2);
            }
            a4.appendChild(c2), c2.classList.add(r);
          }
        } };
      }();
    }, function(t, o3, i2) {
      ...
      t.exports = function(i2) {
        ...
        return n.toString = function() {
          return this.map(function(r) {
            var a4 = function(l3, c2) {
              var u2 = l3[1] || "", h3 = l3[3];
              if (!h3)
                return u2;
              if (c2 && typeof btoa == "function") {
                var f = (p = h3, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(p)))) + " */"), k = h3.sources.map(function(v) {
                  return "/*# sourceURL=" + h3.sourceRoot + v + " */";
                });
                return [u2].concat(k).concat([f]).join(`
`);
              }
              var p;
              return [u2].join(`
`);
            ...
            return r[2] ? "@media " + r[2] + "{" + a4 + "}" : a4;
          }).join("");
        }, n.i = function(r, a4) {
          typeof r == "string" && (r = [[null, r, ""]]);
          for (var l3 = {}, c2 = 0; c2 < this.length; c2++) {
            var u2 = this[c2][0];
            typeof u2 == "number" && (l3[u2] = true);
          }
          for (c2 = 0; c2 < r.length; c2++) {
            var h3 = r[c2];
            typeof h3[0] == "number" && l3[h3[0]] || (a4 && !h3[2] ? h3[2] = a4 : a4 && (h3[2] = "(" + h3[2] + ") and (" + a4 + ")"), n.push(h3));
          }
        }, n;
      };
    }, function(t, o3, i2) {
      var n, r, a4 = {}, l3 = (n = function() {
        return window && document && document.all && !window.atob;
      }, function() {
        return r === void 0 && (r = n.apply(this, arguments)), r;
      }), c2 = /* @__PURE__ */ function(b) {
        var g = {};
        return function(E) {
        ...
        for (var E = 0; E < b.length; E++) {
          ...
          if (O) {
            ...
            for (; S < T.parts.length; S++)
              O.parts.push(x2(T.parts[S], g));
          } else {
            var H2 = [];
            for (S = 0; S < T.parts.length; S++)
              H2.push(x2(T.parts[S], g));
            a4[T.id] = { id: T.id, refs: 1, parts: H2 };
          }
        }
      }
      function v(b, g) {
        for (var E = [], T = {}, O = 0; O < b.length; O++) {
          var S = b[O], H2 = g.base ? S[0] + g.base : S[0], M2 = { css: S[1], media: S[2], sourceMap: S[3] };
          T[H2] ? T[H2].parts.push(M2) : E.push(T[H2] = { id: H2, parts: [M2] });
        }
        return E;
      }
      function A(b, g) {
        var E = c2(b.insertInto);
        if (!E)
...
`);
          var O = c2(b.insertInto + " " + b.insertAt.before);
          E.insertBefore(g, O);
        }
      }
      function N(b) {
      ...
      function x2(b, g) {
        ...
        if (g.singleton) {
          var H2 = h3++;
          E = u2 || (u2 = _2(g)), T = R2.bind(null, E, H2, false), O = R2.bind(null, E, H2, true);
        } else
          b.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (E = function(M2) {
            var W = document.createElement("link");
            return M2.attrs.type === void 0 && (M2.attrs.type = "text/css"), M2.attrs.rel = "stylesheet", y(W, M2.attrs), A(M2, W), W;
          }(g), T = function(M2, W, de) {
...
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Ee)))) + " */");
            var Lt = new Blob([Q], { type: "text/css" }), Ve = M2.href;
            M2.href = URL.createObjectURL(Lt), Ve && URL.revokeObjectURL(Ve);
          }.bind(null, E, g), O = function() {
            N(E), E.href && URL.revokeObjectURL(E.href);
          }) : (E = _2(g), T = function(M2, W) {
            var de = W.css, Q = W.media;
            if (Q && M2.setAttribute("media", Q), M2.styleSheet)
              M2.styleSheet.cssText = de;
            else {
              for (; M2.firstChild; )
                M2.removeChild(M2.firstChild);
              M2.appendChild(document.createTextNode(de));
            }
          }.bind(null, E), O = function() {
            N(E);
          });
        return T(b), function(M2) {
          if (M2) {
            if (M2.css === b.css && M2.media === b.media && M2.sourceMap === b.sourceMap)
              return;
            T(b = M2);
          } else
            O();
      ...
      t.exports = function(b, g) {
        ...
        (g = g || {}).attrs = typeof g.attrs == "object" ? g.attrs : {}, g.singleton || typeof g.singleton == "boolean" || (g.singleton = l3()), g.insertInto || (g.insertInto = "head"), g.insertAt || (g.insertAt = "bottom");
        var E = v(b, g);
        return p(E, g), function(T) {
          for (var O = [], S = 0; S < E.length; S++) {
            var H2 = E[S];
            (M2 = a4[H2.id]).refs--, O.push(M2);
          }
          for (T && p(v(T, g), g), S = 0; S < O.length; S++) {
            var M2;
            if ((M2 = O[S]).refs === 0) {
              for (var W = 0; W < M2.parts.length; W++)
                M2.parts[W]();
              delete a4[M2.id];
            }
          }
...
`);
      ...
      function R2(b, g, E, T) {
        var O = E ? "" : T.css;
        if (b.styleSheet)
          b.styleSheet.cssText = I2(g, O);
        else {
          var S = document.createTextNode(O), H2 = b.childNodes;
          H2[g] && b.removeChild(H2[g]), H2.length ? b.insertBefore(S, H2[g]) : b.appendChild(S);
        }
      }
    }, function(t, o3) {
      t.exports = function(i2) {
        ...
        if (!i2 || typeof i2 != "string")
          return i2;
        var r = n.protocol + "//" + n.host, a4 = r + n.pathname.replace(/\/[^\/]*$/, "/");
        return i2.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(l3, c2) {
          var u2, h3 = c2.trim().replace(/^"(.*)"$/, function(f, k) {
            return k;
          }).replace(/^'(.*)'$/, function(f, k) {
            return k;
          });
          return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(h3) ? l3 : (u2 = h3.indexOf("//") === 0 ? h3 : h3.indexOf("/") === 0 ? r + h3 : a4 + h3.replace(/^\.\//, ""), "url(" + JSON.stringify(u2) + ")");
        });
      };
    }, function(t, o3, i2) {
      var n, r, a4, l3, c2, u2, h3, f, k;
      t.exports = (n = "cdx-notifies", r = "cdx-notify", a4 = "cdx-notify__cross", l3 = "cdx-notify__button--confirm", c2 = "cdx-notify__button--cancel", u2 = "cdx-notify__input", h3 = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: k = function(p) {
        var v = document.createElement("DIV"), A = document.createElement("DIV"), N = p.message, _2 = p.style;
        return v.classList.add(r), _2 && v.classList.add(r + "--" + _2), v.innerHTML = N, A.classList.add(a4), A.addEventListener("click", v.remove.bind(v)), v.appendChild(A), v;
      }, confirm: function(p) {
        var v = k(p), A = document.createElement("div"), N = document.createElement("button"), _2 = document.createElement("button"), y = v.querySelector("." + a4), x2 = p.cancelHandler, w = p.okHandler;
        return A.classList.add(f), N.innerHTML = p.okText || "Confirm", _2.innerHTML = p.cancelText || "Cancel", N.classList.add(h3), _2.classList.add(h3), N.classList.add(l3), _2.classList.add(c2), x2 && typeof x2 == "function" && (_2.addEventListener("click", x2), y.addEventListener("click", x2)), w && typeof w == "function" && N.addEventListener("click", w), N.addEventListener("click", v.remove.bind(v)), _2.addEventListener("click", v.remove.bind(v)), A.appendChild(N), A.appendChild(_2), v.appendChild(A), v;
      }, prompt: function(p) {
        var v = k(p), A = document.createElement("div"), N = document.createElement("button"), _2 = document.createElement("input"), y = v.querySelector("." + a4), x2 = p.cancelHandler, w = p.okHandler;
        return A.classList.add(f), N.innerHTML = p.okText || "Ok", N.classList.add(h3), N.classList.add(l3), _2.classList.add(u2), p.placeholder && _2.setAttribute("placeholder", p.placeholder), p.default && (_2.value = p.default), p.inputType && (_2.type = p.inputType), x2 && typeof x2 == "function" && y.addEventListener("click", x2), w && typeof w == "function" && N.addEventListener("click", function() {
          w(_2.value);
        }), N.addEventListener("click", v.remove.bind(v)), A.appendChild(_2), A.appendChild(N), v.appendChild(A), v;
      }, getWrapper: function() {
...
(function(s2, e) {
  (function(t, o3) {
    ...
    function t(h3) {
      var f = h3.tags, k = Object.keys(f), p = k.map(function(v) {
        return typeof f[v];
      }).every(function(v) {
    ...
    t.prototype.clean = function(h3) {
      ...
      return k.innerHTML = h3, this._sanitize(f, k), k.innerHTML;
    }, t.prototype._sanitize = function(h3, f) {
      var k = a4(h3, f), p = k.firstChild();
      if (p)
        do {
          ...
          var v = r(p), A;
          v && (A = Array.prototype.some.call(p.childNodes, i2));
          var N = !!f.parentNode, _2 = i2(f) && i2(p) && N, y = p.nodeName.toLowerCase(), x2 = l3(this.config, y, p), w = v && A;
          if (w || c2(p, x2) || !this.config.keepNestedBlockElements && _2) {
          ...
          for (var I2 = 0; I2 < p.attributes.length; I2 += 1) {
            var R2 = p.attributes[I2];
            u2(R2, x2, p) && (p.removeAttribute(R2.name), I2 = I2 - 1);
          }
          this._sanitize(h3, p);
    ...
    function l3(h3, f, k) {
      return typeof h3.tags[f] == "function" ? h3.tags[f](k) : h3.tags[f];
    }
    function c2(h3, f) {
    ...
    function u2(h3, f, k) {
      ...
      return f === true ? false : typeof f[p] == "function" ? !f[p](h3.value, k) : typeof f[p] > "u" || f[p] === false ? true : typeof f[p] == "string" ? f[p] !== h3.value : false;
    }
    return t;
  });
})(ho);
...
function Z(s2, e = {}) {
  ...
  return new uo(t).clean(s2);
}
function Fe(s2, e) {
  return Array.isArray(s2) ? po(s2, e) : z(s2) ? fo(s2, e) : J(s2) ? go(s2, e) : s2;
}
function po(s2, e) {
  return s2.map((t) => Fe(t, e));
}
function fo(s2, e) {
  const t = {};
  for (const o3 in s2) {
    if (!Object.prototype.hasOwnProperty.call(s2, o3))
      continue;
    const i2 = s2[o3], n = bo(e[o3]) ? e[o3] : e;
    t[o3] = Fe(i2, n);
  }
  return t;
}
function go(s2, e) {
  return z(e) ? Z(s2, e) : e === false ? Z(s2, {}) : s2;
}
function bo(s2) {
  return z(s2) || Rt(s2) || D(s2);
}
...
var vo = class extends C {
   ...
   */
  findParentTag(e, t) {
    return new m2().findParentTag(e, t);
  }
  /**
      ...
      class n {
        ...
        loadStyles() {
          ...
          if (document.getElementById(a4))
            return;
          const l3 = i2(2), c2 = this.make("style", null, { textContent: l3.toString(), id: a4 });
          this.prepend(document.head, c2);
        }
        placeBottom(a4, l3) {
          const c2 = a4.getBoundingClientRect(), u2 = c2.left + a4.clientWidth / 2 - this.nodes.wrapper.offsetWidth / 2, h3 = c2.bottom + window.pageYOffset + this.offsetTop + l3.marginTop;
          this.applyPlacement("bottom", u2, h3);
        }
        placeTop(a4, l3) {
          const c2 = a4.getBoundingClientRect(), u2 = c2.left + a4.clientWidth / 2 - this.nodes.wrapper.offsetWidth / 2, h3 = c2.top + window.pageYOffset - this.nodes.wrapper.clientHeight - this.offsetTop;
          this.applyPlacement("top", u2, h3);
        }
        placeLeft(a4, l3) {
          const c2 = a4.getBoundingClientRect(), u2 = c2.left - this.nodes.wrapper.offsetWidth - this.offsetLeft - l3.marginLeft, h3 = c2.top + window.pageYOffset + a4.clientHeight / 2 - this.nodes.wrapper.offsetHeight / 2;
          this.applyPlacement("left", u2, h3);
        }
        placeRight(a4, l3) {
          const c2 = a4.getBoundingClientRect(), u2 = c2.right + this.offsetRight + l3.marginRight, h3 = c2.top + window.pageYOffset + a4.clientHeight / 2 - this.nodes.wrapper.offsetHeight / 2;
          this.applyPlacement("right", u2, h3);
        }
        applyPlacement(a4, l3, c2) {
          this.nodes.wrapper.classList.add(this.CSS.placement[a4]), this.nodes.wrapper.style.left = l3 + "px", this.nodes.wrapper.style.top = c2 + "px";
        }
        make(a4, l3 = null, c2 = {}) {
          const u2 = document.createElement(a4);
          Array.isArray(l3) ? u2.classList.add(...l3) : l3 && u2.classList.add(l3);
          for (const h3 in c2)
            c2.hasOwnProperty(h3) && (u2[h3] = c2[h3]);
          return u2;
        }
        append(a4, l3) {
          Array.isArray(l3) ? l3.forEach((c2) => a4.appendChild(c2)) : a4.appendChild(l3);
        }
        prepend(a4, l3) {
          Array.isArray(l3) ? (l3 = l3.reverse()).forEach((c2) => a4.prepend(c2)) : a4.prepend(l3);
        }
      }
    }, function(t, o3) {
...
function pt(s2, e) {
  const t = {};
  return Object.entries(s2).forEach(([o3, i2]) => {
    if (z(i2)) {
      const n = e ? `${e}.${o3}` : o3;
      Object.values(i2).every((a4) => J(a4)) ? t[o3] = n : t[o3] = pt(i2, n);
      return;
    }
    t[o3] = i2;
  }), t;
...
function Co(s2, e) {
  const t = {};
  return Object.keys(s2).forEach((o3) => {
    const i2 = e[o3];
    i2 !== void 0 ? t[i2] = s2[o3] : t[o3] = s2[o3];
  }), t;
}
...
var he = class {
   ...
   */
  constructor(s2, e) {
    this.cursor = -1, this.items = [], this.items = s2 || [], this.focusedCssClass = e;
  }
  /**
  ...
  leafNodesAndReturnIndex(s2) {
    if (this.items.length === 0)
      return this.cursor;
    let e = this.cursor;
    return e === -1 ? e = s2 === he.directions.RIGHT ? -1 : 0 : this.items[e].classList.remove(this.focusedCssClass), s2 === he.directions.RIGHT ? e = (e + 1) % this.items.length : e = (this.items.length + e - 1) % this.items.length, d.canSetCaret(this.items[e]) && re(() => m2.setCursor(this.items[e]), 50)(), this.items[e].classList.add(this.focusedCssClass), e;
  }
};
var ne = he;
ne.directions = {
...
var Ho = (s2, e, t, o3) => {
  for (var i2 = o3 > 1 ? void 0 : o3 ? Fo(e, t) : e, n = s2.length - 1, r; n >= 0; n--)
    (r = s2[n]) && (i2 = (o3 ? r(e, t, i2) : r(i2)) || i2);
  return o3 && i2 && Po(e, t, i2), i2;
};
var ge = /* @__PURE__ */ ((s2) => (s2.Close = "close", s2))(ge || {});
var j = class extends we {
  ...
  constructor(s2) {
    ...
    }, this.items = s2.items.map((e) => new P(e)), s2.scopeElement !== void 0 && (this.scopeElement = s2.scopeElement), s2.messages && (this.messages = {
      ...this.messages,
      ...s2.messages
   ...
   */
  hide() {
    this.nodes.popover.classList.remove(j.CSS.popoverOpened), this.nodes.popover.classList.remove(j.CSS.popoverOpenTop), this.nodes.overlay.classList.add(j.CSS.overlayHidden), this.flipper.deactivate(), this.items.forEach((s2) => s2.reset()), this.search !== void 0 && this.search.clear(), te() && this.scrollLocker.unlock(), this.emit(
      "close"
      /* Close */
    );
  }
   ...
   */
  getTargetItem(s2) {
    return this.items.find((e) => s2.composedPath().includes(e.getElement()));
  }
  /**
   * Handles item clicks
   *
   ...
   */
  handleItemClick(s2) {
    s2.isDisabled || (this.items.filter((e) => e !== s2).forEach((e) => e.reset()), s2.handleClick(), this.toggleItemActivenessIfNeeded(s2), s2.closeOnActivate && this.hide());
  }
  /**
  ...
  get flippableElements() {
    const s2 = this.items.map((t) => t.getElement());
  ...
  get height() {
    ...
    return e.style.visibility = "hidden", e.style.position = "absolute", e.style.top = "-1000px", e.classList.add(j.CSS.popoverOpened), document.body.appendChild(e), s2 = e.offsetHeight, e.remove(), s2;
  }
  /**
  ...
  get shouldOpenBottom() {
    const s2 = this.nodes.popover.getBoundingClientRect(), e = this.scopeElement.getBoundingClientRect(), t = this.height, o3 = s2.top + t, i2 = s2.top - t, n = Math.min(window.innerHeight, e.bottom);
  ...
  toggleCustomContent(s2) {
    var e;
    (e = this.nodes.customContent) == null || e.classList.toggle(j.CSS.customContentHidden, s2);
  }
  /**
  ...
  toggleItemActivenessIfNeeded(s2) {
    if (s2.toggle === true && s2.toggleActive(), typeof s2.toggle == "string") {
      const e = this.items.filter((t) => t.toggle === s2.toggle);
      if (e.length === 1) {
        s2.toggleActive();
        return;
      }
...
var jo = class extends C {
  constructor() {
    super(...arguments), this.opened = false, this.selection = new m2(), this.onPopoverClose = () => {
      this.close();
    };
  }
  /**
...
var Y = class _Y extends C {
  ...
  addTool(e, t) {
    ...
    o3.dataset.tool = e, i2.innerHTML = t.icon, d.append(o3, i2), d.append(o3, d.text($2.t(X.toolNames, t.title || ae(e))));
    const n = (r = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : r.shortcut;
    if (n) {
      const a4 = d.make("span", _Y.CSS.conversionToolSecondaryLabel, {
        innerText: Re(n)
      });
      d.append(o3, a4);
    }
    ...
    return function(t) {
      ...
      function n(l3, c2) {
        for (var u2 = 0; u2 < c2.length; u2++) {
          var h3 = c2[u2];
          h3.enumerable = h3.enumerable || false, h3.configurable = true, "value" in h3 && (h3.writable = true), Object.defineProperty(l3, h3.key, h3);
        }
      }
      function r(l3, c2, u2) {
        return c2 && n(l3.prototype, c2), u2 && n(l3, u2), l3;
      }
      i2.r(o3);
      var a4 = function() {
        function l3(c2) {
          ...
          })(this, l3), this.commands = {}, this.keys = {}, this.name = c2.name, this.parseShortcutName(c2.name), this.element = c2.on, this.callback = c2.callback, this.executeShortcut = function(h3) {
            u2.execute(h3);
          }, this.element.addEventListener("keydown", this.executeShortcut, false);
        }
        return r(l3, null, [{ key: "supportedCommands", get: function() {
          return { SHIFT: ["SHIFT"], CMD: ["CMD", "CONTROL", "COMMAND", "WINDOWS", "CTRL"], ALT: ["ALT", "OPTION"] };
        } }, { key: "keyCodes", get: function() {
          return { 0: 48, 1: 49, 2: 50, 3: 51, 4: 52, 5: 53, 6: 54, 7: 55, 8: 56, 9: 57, A: 65, B: 66, C: 67, D: 68, E: 69, F: 70, G: 71, H: 72, I: 73, J: 74, K: 75, L: 76, M: 77, N: 78, O: 79, P: 80, Q: 81, R: 82, S: 83, T: 84, U: 85, V: 86, W: 87, X: 88, Y: 89, Z: 90, BACKSPACE: 8, ENTER: 13, ESCAPE: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, INSERT: 45, DELETE: 46, ".": 190 };
        } }]), r(l3, [{ key: "parseShortcutName", value: function(c2) {
          c2 = c2.split("+");
          for (var u2 = 0; u2 < c2.length; u2++) {
            c2[u2] = c2[u2].toUpperCase();
            var h3 = false;
            for (var f in l3.supportedCommands)
              if (l3.supportedCommands[f].includes(c2[u2])) {
                h3 = this.commands[f] = true;
                break;
              }
            h3 || (this.keys[c2[u2]] = true);
          }
          for (var k in l3.supportedCommands)
            this.commands[k] || (this.commands[k] = false);
        } }, { key: "execute", value: function(c2) {
          var u2, h3 = { CMD: c2.ctrlKey || c2.metaKey, SHIFT: c2.shiftKey, ALT: c2.altKey }, f = true;
          for (u2 in this.commands)
            this.commands[u2] !== h3[u2] && (f = false);
          var k, p = true;
          for (k in this.keys)
            p = p && c2.keyCode === l3.keyCodes[k];
          f && p && this.callback(c2);
...
var bt = (s2, e, t, o3) => {
  for (var i2 = o3 > 1 ? void 0 : o3 ? Yo(e, t) : e, n = s2.length - 1, r; n >= 0; n--)
    (r = s2[n]) && (i2 = (o3 ? r(e, t, i2) : r(i2)) || i2);
  return o3 && i2 && Wo(e, t, i2), i2;
};
var me = /* @__PURE__ */ ((s2) => (s2.Opened = "toolbox-opened", s2.Closed = "toolbox-closed", s2.BlockAdded = "toolbox-block-added", s2))(me || {});
var mt = class extends we {
   ...
   */
  constructor({ api: s2, tools: e, i18nLabels: t }) {
    ...
    }, this.api = s2, this.tools = e, this.i18nLabels = t;
  }
  /**
   ...
   */
  toolButtonActivated(s2, e) {
    this.insertNewBlock(s2, e);
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    const s2 = (e, t) => ({
      icon: e.icon,
      title: $2.t(X.toolNames, e.title || ae(t.name)),
      name: t.name,
      onActivate: () => {
    ...
    return this.toolsToBeDisplayed.reduce((e, t) => (Array.isArray(t.toolbox) ? t.toolbox.forEach((o3) => {
      e.push(s2(o3, t));
    }) : t.toolbox !== void 0 && e.push(s2(t.toolbox, t)), e), []);
  }
  /**
  ...
  enableShortcuts() {
    this.toolsToBeDisplayed.forEach((s2) => {
      const e = s2.shortcut;
      e && this.enableShortcutForTool(s2.name, e);
    });
  }
  /**
  ...
  async insertNewBlock(s2, e) {
    ...
    let n;
    if (e) {
      const a4 = await this.api.blocks.composeBlockData(s2);
      n = Object.assign(a4, e);
    }
...
var Ko = class extends C {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    if (this.toolboxInstance.opened && this.toolboxInstance.close(), this.Editor.BlockSettings.opened && this.Editor.BlockSettings.close(), !e)
      return;
    this.hoveredBlock = e;
    const t = e.holder, { isMobile: o3 } = this.Editor.UI, i2 = e.pluginsContent, n = window.getComputedStyle(i2), r = parseInt(n.paddingTop, 10), a4 = t.offsetHeight;
    let l3;
    o3 ? l3 = t.offsetTop + a4 : l3 = t.offsetTop + r, this.nodes.wrapper.style.top = `${Math.floor(l3)}px`, this.Editor.BlockManager.blocks.length === 1 && e.isEmpty ? this.blockTunesToggler.hide() : this.blockTunesToggler.show(), this.open();
  }
  /**
   * Close the Toolbar
   */
...
var ke = /* @__PURE__ */ ((s2) => (s2.Shortcut = "shortcut", s2.Toolbox = "toolbox", s2.EnabledInlineTools = "inlineToolbar", s2.EnabledBlockTunes = "tunes", s2.Config = "config", s2))(ke || {});
var vt = /* @__PURE__ */ ((s2) => (s2.Shortcut = "shortcut", s2.SanitizeConfig = "sanitize", s2))(vt || {});
...
var Ue = /* @__PURE__ */ ((s2) => (s2.IsInline = "isInline", s2.Title = "title", s2))(Ue || {});
var xt = /* @__PURE__ */ ((s2) => (s2.IsTune = "isTune", s2))(xt || {});
var $e = class {
  /**
   * @class
  ...
  constructor({
    ...
    this.api = i2, this.name = e, this.constructable = t, this.config = o3, this.isDefault = n, this.isInternal = r, this.defaultPlaceholder = a4;
  }
  /**
...
var Xo = class extends C {
   ...
   */
  move() {
    const e = m2.rect, t = this.Editor.UI.nodes.wrapper.getBoundingClientRect(), o3 = {
      x: e.x - t.left,
   ...
   */
  allowedToShow() {
    const e = ["IMG", "INPUT"], t = m2.get(), o3 = m2.text;
  ...
  addConversionToggler() {
    ...
    }), te() === false && this.tooltip.onHover(this.nodes.conversionToggler, $2.ui(X.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
   ...
   */
  addToolsFiltered() {
    const e = m2.get(), t = this.Editor.BlockManager.getBlock(e.anchorNode);
...
var Vo = class extends C {
  ...
  tabPressed(e) {
    ...
    if (!n)
      return;
    const r = n.isEmpty, a4 = n.tool.isDefault && r, l3 = !r && i2.opened, c2 = !r && !m2.isCollapsed && o3.opened;
    a4 ? this.activateToolbox() : !l3 && !c2 && this.activateBlockSettings();
  }
  /**
  ...
  backspace(e) {
    ...
    if (!m2.isCollapsed || !o3.isAtStart)
      return;
    ...
    if (i2.isEmpty) {
      ...
      o3.setToBlock(l3, o3.positions.END);
      return;
    }
...
var Go = class extends C {
  ...
  composeBlock({
    ...
    const n = this.Editor.ReadOnly.isEnabled, r = this.Editor.Tools.blockTools.get(e), a4 = new F({
      id: o3,
      data: t,
      tool: r,
      api: this.Editor.API,
  ...
  insert({
    ...
    let l3 = i2;
    l3 === void 0 && (l3 = this.currentBlockIndex + (r ? 0 : 1));
    ...
    return r && this.blockDidMutated(et, this.getBlockByIndex(l3), {
      index: l3
    }), this._blocks.insert(l3, c2, r), this.blockDidMutated(tt, c2, {
      index: l3
    }), n ? this.currentBlockIndex = l3 : l3 <= this.currentBlockIndex && this.currentBlockIndex++, c2;
  }
  /**
   * Inserts several blocks at once
   *
  ...
  async convert(e, t, o3) {
    ...
    const r = await e.exportDataAsString(), a4 = Z(
      r,
      n.sanitizeConfig
    );
    let l3 = Jt(a4, n.conversionConfig);
    o3 && (l3 = Object.assign(l3, o3)), this.replace(e, n.name, l3);
  }
  /**
...
var Jo = class extends C {
   ...
   */
  toggleReadOnly() {
    m2.get().removeAllRanges(), this.allBlocksSelected = false;
  }
  /**
  ...
  clearSelection(e, t = false) {
    ...
    const r = e && e instanceof KeyboardEvent, a4 = r && nt(e.keyCode);
    if (this.anyBlockSelected && r && a4 && !m2.isSelectionExists) {
      const l3 = o3.removeSelectedBlocks();
      o3.insertDefaultBlockAtIndex(l3, true), i2.setToBlock(o3.currentBlock), re(() => {
        const c2 = e.key;
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((n) => {
      const r = Z(n.holder.innerHTML, this.sanitizerConfig), a4 = d.make("p");
      a4.innerHTML = r, t.appendChild(a4);
    });
...
`), i2 = t.innerHTML;
  ...
  selectBlockByIndex(e) {
    ...
    t.clearFocused();
    let o3;
    isNaN(e) ? o3 = t.currentBlock : o3 = t.getBlockByIndex(e), this.selection.save(), m2.get().removeAllRanges(), o3.selected = true, this.clearCache(), this.Editor.InlineToolbar.close();
  }
  /**
   ...
   */
  selectAllBlocks() {
    this.selection.save(), m2.get().removeAllRanges(), this.allBlocksSelected = true, this.Editor.InlineToolbar.close();
  }
};
var ve = class _ve extends C {
   ...
   */
  get isAtStart() {
    const e = m2.get(), t = d.getDeepestNode(this.Editor.BlockManager.currentBlock.currentInput);
    let o3 = e.focusNode;
    ...
    i2 === -1 && (i2 = 0);
    let n = e.focusOffset;
    return o3.nodeType !== Node.TEXT_NODE && o3.childNodes.length && (o3.childNodes[n] ? (o3 = o3.childNodes[n], n = 0) : (o3 = o3.childNodes[n - 1], n = o3.textContent.length)), (d.isLineBreakTag(t) || d.isEmpty(t)) && this.getHigherLevelSiblings(o3, "left").every((l3) => {
      const c2 = d.isLineBreakTag(l3), u2 = l3.children.length === 1 && d.isLineBreakTag(l3.children[0]), h3 = c2 || u2;
      return d.isEmpty(l3) && !h3;
  ...
  get isAtEnd() {
    ...
    if (t.nodeType !== Node.TEXT_NODE && t.childNodes.length && (t.childNodes[i2 - 1] ? (t = t.childNodes[i2 - 1], i2 = t.textContent.length) : (t = t.childNodes[0], i2 = 0)), d.isLineBreakTag(o3) || d.isEmpty(o3)) {
      ...
      if (r.every((l3, c2) => c2 === r.length - 1 && d.isLineBreakTag(l3) || d.isEmpty(l3) && !d.isLineBreakTag(l3)) && i2 === t.textContent.length)
        return true;
    }
  ...
  setToBlock(e, t = this.positions.DEFAULT, o3 = 0) {
    ...
    if (!n)
      return;
    const r = d.getDeepestNode(n, t === this.positions.END), a4 = d.getContentLength(r);
    switch (true) {
   ...
   */
  set(e, t = 0) {
    const { top: o3, bottom: i2 } = m2.setCursor(e, t), { innerHeight: n } = window;
  ...
  extractFragmentFromCaretPosition() {
    ...
    if (e.rangeCount) {
      ...
      if (t.deleteContents(), o3)
        if (d.isNativeInput(o3)) {
          const i2 = o3, n = document.createDocumentFragment(), r = i2.value.substring(0, i2.selectionStart), a4 = i2.value.substring(i2.selectionStart);
          return n.textContent = a4, i2.value = r, n;
        } else {
  ...
  insertContentAtCaretPosition(e) {
    const t = document.createDocumentFragment(), o3 = document.createElement("div"), i2 = m2.get(), n = m2.range;
    o3.innerHTML = e, Array.from(o3.childNodes).forEach((c2) => t.appendChild(c2)), t.childNodes.length === 0 && t.appendChild(new Text());
    const r = t.lastChild;
    n.deleteContents(), n.insertNode(t);
    const a4 = document.createRange(), l3 = r.nodeType === Node.TEXT_NODE ? r : r.firstChild;
    l3 !== null && l3.textContent !== null && a4.setStart(l3, l3.textContent.length), i2.removeAllRanges(), i2.addRange(a4);
  }
  /**
...
var Qo = class extends C {
    ...
    super(...arguments), this.onMouseUp = () => {
      ...
      if (!(!i2 || !n) && n !== i2) {
        if (i2 === this.firstSelectedBlock) {
          m2.get().removeAllRanges(), i2.selected = true, n.selected = true, o3.clearCache();
          return;
        }
  ...
  toggleBlockSelectedState(e = true) {
    ...
    this.lastSelectedBlock || (this.lastSelectedBlock = this.firstSelectedBlock = t.currentBlock), this.firstSelectedBlock === this.lastSelectedBlock && (this.firstSelectedBlock.selected = true, o3.clearCache(), m2.get().removeAllRanges());
  ...
  enableCrossBlockSelection(e) {
    ...
    m2.isCollapsed || this.Editor.BlockSelection.clearSelection(e), t.nodes.redactor.contains(e.target) ? this.watchSelection(e) : this.Editor.BlockSelection.clearSelection(e);
  }
  /**
  ...
  toggleBlocksSelectedState(e, t) {
    const { BlockManager: o3, BlockSelection: i2 } = this.Editor, n = o3.blocks.indexOf(e), r = o3.blocks.indexOf(t), a4 = e.selected !== t.selected;
    for (let l3 = Math.min(n, r); l3 <= Math.max(n, r); l3++) {
      const c2 = o3.blocks[l3];
      c2 !== this.firstSelectedBlock && c2 !== (a4 ? e : t) && (o3.blocks[l3].selected = !o3.blocks[l3].selected, i2.clearCache());
    }
  }
};
var ei = class extends C {
  ...
  async processDrop(e) {
    ...
    e.preventDefault(), t.blocks.forEach((r) => {
      r.dropTarget = false;
    }), m2.isAtEditor && !m2.isCollapsed && this.isStartedAtEditor && document.execCommand("delete"), this.isStartedAtEditor = false;
   ...
   */
  processDragStart() {
    m2.isAtEditor && !m2.isCollapsed && (this.isStartedAtEditor = true), this.Editor.InlineToolbar.close();
  }
  /**
...
var wt = class extends C {
  constructor() {
    super(...arguments), this.MIME_TYPE = "application/x-editor-js", this.toolsTags = {}, this.tagsByTool = {}, this.toolsPatterns = [], this.toolsFiles = {}, this.exceptionList = [], this.processTool = (s2) => {
      ...
      const { BlockManager: e, Toolbar: t } = this.Editor, o3 = e.setCurrentBlockByChildNode(s2.target);
      !o3 || this.isNativeBehaviour(s2.target) && !s2.clipboardData.types.includes("Files") || o3 && this.exceptionList.includes(o3.name) || (s2.preventDefault(), this.processDataTransfer(s2.clipboardData), e.clearFocused(), t.close());
    };
  }
  /**
   ...
   */
  async processDataTransfer(s2, e = false) {
    const { Tools: t } = this.Editor, o3 = s2.types;
    if ((o3.includes ? o3.includes("Files") : o3.contains("Files")) && !V(this.toolsFiles)) {
      await this.processFiles(s2.files);
      return;
    }
    const n = s2.getData(this.MIME_TYPE), r = s2.getData("text/plain");
    let a4 = s2.getData("text/html");
    if (n)
      try {
    ...
    e && r.trim() && a4.trim() && (a4 = "<p>" + (a4.trim() ? a4 : r) + "</p>");
    const l3 = Object.keys(this.toolsTags).reduce((h3, f) => (h3[f.toLowerCase()] = this.toolsTags[f].sanitizationConfig ?? {}, h3), {}), c2 = Object.assign({}, l3, t.getAllInlineToolsSanitizeConfig(), { br: {} }), u2 = Z(a4, c2);
    !u2.trim() || u2.trim() === r || !d.isHTMLString(u2) ? await this.processText(r) : await this.processText(u2, true);
  }
  /**
   ...
   */
  async processText(s2, e = false) {
    const { Caret: t, BlockManager: o3 } = this.Editor, i2 = e ? this.processHTML(s2) : this.processPlain(s2);
    if (!i2.length)
      return;
    if (i2.length === 1) {
    ...
    i2.map(
      async (a4, l3) => this.insertBlock(a4, l3 === 0 && r)
  ...
  getTagsConfig(s2) {
    if (s2.pasteConfig === false)
      return;
    const e = s2.pasteConfig.tags || [], t = [];
    e.forEach((o3) => {
      const i2 = this.collectTagNames(o3);
      t.push(...i2), i2.forEach((n) => {
        if (Object.prototype.hasOwnProperty.call(this.toolsTags, n)) {
          L(
            `Paste handler for \xAB${s2.name}\xBB Tool on \xAB${n}\xBB tag is skipped because it is already used by \xAB${this.toolsTags[n].tool.name}\xBB Tool.`,
            "warn"
          );
          return;
        }
    ...
    }), this.tagsByTool[s2.name] = t.map((o3) => o3.toUpperCase());
  }
  /**
  ...
  getFilesConfig(s2) {
    if (s2.pasteConfig === false)
      return;
    const { files: e = {} } = s2.pasteConfig;
    let { extensions: t, mimeTypes: o3 } = e;
    !t && !o3 || (t && !Array.isArray(t) && (L(`\xABextensions\xBB property of the onDrop config for \xAB${s2.name}\xBB Tool should be an array`), t = []), o3 && !Array.isArray(o3) && (L(`\xABmimeTypes\xBB property of the onDrop config for \xAB${s2.name}\xBB Tool should be an array`), o3 = []), o3 && (o3 = o3.filter((i2) => Ft(i2) ? true : (L(`MIME type value \xAB${i2}\xBB for the \xAB${s2.name}\xBB Tool is not a valid MIME type`, "warn"), false))), this.toolsFiles[s2.name] = {
      extensions: t || [],
      mimeTypes: o3 || []
    });
  }
  ...
  getPatternsConfig(s2) {
    s2.pasteConfig === false || !s2.pasteConfig.patterns || V(s2.pasteConfig.patterns) || Object.entries(s2.pasteConfig.patterns).forEach(([e, t]) => {
      t instanceof RegExp || L(
        `Pattern ${t} for \xAB${s2.name}\xBB Tool is skipped because it should be a Regexp instance.`,
        "warn"
  ...
  async processFiles(s2) {
    ...
    let t;
    t = await Promise.all(
      Array.from(s2).map((n) => this.processFile(n))
    ), t = t.filter((n) => !!n);
  ...
  async processFile(s2) {
    const e = Pt(s2), t = Object.entries(this.toolsFiles).find(([n, { mimeTypes: r, extensions: a4 }]) => {
      const [l3, c2] = s2.type.split("/"), u2 = a4.find((f) => f.toLowerCase() === e.toLowerCase()), h3 = r.find((f) => {
        const [k, p] = f.split("/");
        return k === l3 && (p === c2 || p === "*");
      });
      return !!u2 || !!h3;
  ...
  processHTML(s2) {
    ...
    return t.innerHTML = s2, this.getNodes(t).map((i2) => {
      let n, r = e.defaultTool, a4 = false;
      switch (i2.nodeType) {
        case Node.DOCUMENT_FRAGMENT_NODE:
          n = d.make("div"), n.appendChild(i2);
          break;
        case Node.ELEMENT_NODE:
          n = i2, a4 = true, this.toolsTags[n.tagName] && (r = this.toolsTags[n.tagName].tool);
          break;
      }
      const { tags: l3 } = r.pasteConfig || { tags: [] }, c2 = l3.reduce((f, k) => (this.collectTagNames(k).forEach((v) => {
        const A = z(k) ? k[v] : null;
        f[v.toLowerCase()] = A || {};
      }), f), {}), u2 = Object.assign({}, c2, r.baseSanitizeConfig);
      if (n.tagName.toLowerCase() === "table") {
        const f = Z(n.outerHTML, u2);
        n = d.make("div", void 0, {
          innerHTML: f
        }).firstChild;
      } else
        n.innerHTML = Z(n.innerHTML, u2);
  ...
  async processSingleBlock(s2) {
    ...
    if (!o3 || s2.tool !== o3.name || !d.containsOnlyInlineElements(s2.content.innerHTML)) {
      this.insertBlock(s2, (o3 == null ? void 0 : o3.tool.isDefault) && o3.isEmpty);
      return;
    }
    e.insertContentAtCaretPosition(s2.content.innerHTML);
  }
  /**
  ...
  async processInlinePaste(s2) {
    const { BlockManager: e, Caret: t } = this.Editor, { content: o3 } = s2;
    if (e.currentBlock && e.currentBlock.tool.isDefault && o3.textContent.length < wt.PATTERN_PROCESSING_MAX_LENGTH) {
      ...
      if (n) {
        const r = e.currentBlock && e.currentBlock.tool.isDefault && e.currentBlock.isEmpty, a4 = e.paste(n.tool, n.event, r);
   ...
   * @returns {void}
   */
  insertBlock(s2, e = false) {
    const { BlockManager: t, Caret: o3 } = this.Editor, { currentBlock: i2 } = t;
    let n;
    if (e && i2 && i2.isEmpty) {
      n = t.paste(s2.tool, s2.event, true), o3.setToBlock(n, o3.positions.END);
      return;
    }
    n = t.paste(s2.tool, s2.event), o3.setToBlock(n, o3.positions.END);
  }
  /**
  ...
  insertEditorJSData(s2) {
    ...
    ).forEach(({ tool: n, data: r }, a4) => {
      let l3 = false;
      a4 === 0 && (l3 = e.currentBlock && e.currentBlock.tool.isDefault && e.currentBlock.isEmpty);
      const c2 = e.insert({
        tool: n,
        data: r,
        replace: l3
      });
      t.setToBlock(c2, t.positions.END);
    });
  }
  /**
   ...
   */
  processElementNode(s2, e, t) {
    const o3 = Object.keys(this.toolsTags), i2 = s2, { tool: n } = this.toolsTags[i2.tagName] || {}, r = this.tagsByTool[n == null ? void 0 : n.name] || [], a4 = o3.includes(i2.tagName), l3 = d.blockElements.includes(i2.tagName.toLowerCase()), c2 = Array.from(i2.children).some(
      ({ tagName: h3 }) => o3.includes(h3) && !r.includes(h3)
    ), u2 = Array.from(i2.children).some(
      ({ tagName: h3 }) => d.blockElements.includes(h3.toLowerCase())
    );
    if (!l3 && !a4 && !c2)
   ...
   */
  getNodes(s2) {
    const e = Array.from(s2.childNodes);
    let t;
    const o3 = (i2, n) => {
      ...
      switch (r && d.isFragment(r) && (a4 = i2.pop()), n.nodeType) {
        case Node.ELEMENT_NODE:
          if (t = this.processElementNode(n, i2, a4), t)
            return t;
          break;
        case Node.TEXT_NODE:
          return a4.appendChild(n), [...i2, a4];
        default:
          return [...i2, a4];
      }
...
var fe = class _fe extends C {
  ...
  startSelection(e, t) {
    ...
    ], r = o3.closest("." + this.Editor.UI.CSS.editorWrapper), a4 = n.some((l3) => !!o3.closest(l3));
    !r || a4 || (this.mousedown = true, this.startX = e, this.startY = t);
  }
  /**
  ...
  changingRectangle(e) {
    ...
    this.rectCrossesBlocks = !(n || r), this.isRectSelectionActivated || (this.rectCrossesBlocks = false, this.isRectSelectionActivated = true, this.shrinkRectangleToPoint(), this.overlayRectangle.style.display = "block"), this.updateRectangleSize(), this.Editor.Toolbar.close(), i2 !== void 0 && (this.trySelectNextBlock(i2), this.inverseSelection(), m2.get().removeAllRanges());
  }
  /**
  ...
  genInfoForMouseSelection() {
    ...
    let r;
    n !== void 0 && (r = this.Editor.BlockManager.blocks.findIndex((h3) => h3.holder === n.holder));
    const a4 = this.Editor.BlockManager.lastBlock.holder.querySelector("." + F.CSS.content), l3 = Number.parseInt(window.getComputedStyle(a4).width, 10) / 2, c2 = t - l3, u2 = t + l3;
    return {
      index: r,
      leftPos: c2,
      rightPos: u2
  ...
  trySelectNextBlock(e) {
    ...
    let l3 = r;
    o3 > 1 && (l3 = a4 ? i2 : n);
    const c2 = e > this.stackOfSelected[o3 - 1] && l3 === i2, u2 = e < this.stackOfSelected[o3 - 1] && l3 === n, f = !(c2 || u2 || l3 === r);
    ...
    if (!f)
      return;
    let k = o3 - 1, p;
    for (e > this.stackOfSelected[o3 - 1] ? p = () => e > this.stackOfSelected[k] : p = () => e < this.stackOfSelected[k]; p(); )
...
var ii = class extends C {
  ...
  async render(e) {
    return new Promise((t) => {
      const { Tools: o3, BlockManager: i2 } = this.Editor, n = e.map(({ type: r, data: a4, tunes: l3, id: c2 }) => {
        o3.available.has(r) === false && (K(`Tool \xAB${r}\xBB is not found. Check 'tools' property at the Editor.js config.`, "warn"), a4 = this.composeStubDataForTool(r, a4, c2), r = o3.stubTool);
        let u2;
        try {
          u2 = i2.composeBlock({
            id: c2,
          ...
          L(`Block \xAB${r}\xBB skipped because of plugins error`, "error", {
            data: a4,
            error: h3
          }), a4 = this.composeStubDataForTool(r, a4, c2), r = o3.stubTool, u2 = i2.composeBlock({
            id: c2,
            tool: r,
            data: a4,
            tunes: l3
...
var ni = class extends C {
  ...
  async save() {
    ...
    try {
      ...
      const n = await Promise.all(i2), r = await ut(n, (a4) => t.blockTools.get(a4).sanitizeConfig);
  ...
  makeOutput(e) {
    const t = [];
    return e.forEach(({ id: o3, tool: i2, data: n, tunes: r, isValid: a4 }) => {
      if (!a4) {
...
(function(s2, e) {
  (function(t, o3) {
    ...
    return function(t) {
      ...
      var a4 = { insert: "head", singleton: false };
      n(r, a4), t.exports = r.locals || {};
    }, function(t, o3, i2) {
      var n, r = function() {
        return n === void 0 && (n = !!(window && document && document.all && !window.atob)), n;
      }, a4 = /* @__PURE__ */ function() {
        var y = {};
        return function(x2) {
          if (y[x2] === void 0) {
            var w = document.querySelector(x2);
      ...
      function c2(y) {
        for (var x2 = -1, w = 0; w < l3.length; w++)
          if (l3[w].identifier === y) {
            x2 = w;
            break;
          }
        return x2;
      ...
      function u2(y, x2) {
        for (var w = {}, I2 = [], R2 = 0; R2 < y.length; R2++) {
          var b = y[R2], g = x2.base ? b[0] + x2.base : b[0], E = w[g] || 0, T = "".concat(g, " ").concat(E);
          w[g] = E + 1;
          var O = c2(T), S = { css: b[1], media: b[2], sourceMap: b[3] };
          O !== -1 ? (l3[O].references++, l3[O].updater(S)) : l3.push({ identifier: T, updater: _2(S, x2), references: 1 }), I2.push(T);
        }
        return I2;
      }
      function h3(y) {
        var x2 = document.createElement("style"), w = y.attributes || {};
        if (w.nonce === void 0) {
          var I2 = i2.nc;
          I2 && (w.nonce = I2);
        }
        if (Object.keys(w).forEach(function(b) {
          x2.setAttribute(b, w[b]);
        }), typeof y.insert == "function")
          y.insert(x2);
        else {
          var R2 = a4(y.insert || "head");
          if (!R2)
      ...
      var f, k = (f = [], function(y, x2) {
        return f[y] = x2, f.filter(Boolean).join(`
`);
      });
      function p(y, x2, w, I2) {
        var R2 = w ? "" : I2.media ? "@media ".concat(I2.media, " {").concat(I2.css, "}") : I2.css;
        if (y.styleSheet)
          y.styleSheet.cssText = k(x2, R2);
        else {
          var b = document.createTextNode(R2), g = y.childNodes;
          g[x2] && y.removeChild(g[x2]), g.length ? y.insertBefore(b, g[x2]) : y.appendChild(b);
        }
      }
      function v(y, x2, w) {
        var I2 = w.css, R2 = w.media, b = w.sourceMap;
        if (R2 ? y.setAttribute("media", R2) : y.removeAttribute("media"), b && btoa && (I2 += `
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(b)))), " */")), y.styleSheet)
          y.styleSheet.cssText = I2;
        else {
          for (; y.firstChild; )
            y.removeChild(y.firstChild);
          y.appendChild(document.createTextNode(I2));
        }
      }
      var A = null, N = 0;
      function _2(y, x2) {
        ...
        if (x2.singleton) {
          var b = N++;
          w = A || (A = h3(x2)), I2 = p.bind(null, w, b, false), R2 = p.bind(null, w, b, true);
        } else
          w = h3(x2), I2 = v.bind(null, w, x2), R2 = function() {
            (function(g) {
      ...
      t.exports = function(y, x2) {
        (x2 = x2 || {}).singleton || typeof x2.singleton == "boolean" || (x2.singleton = r());
        var w = u2(y = y || [], x2);
        return function(I2) {
          if (I2 = I2 || [], Object.prototype.toString.call(I2) === "[object Array]") {
            for (var R2 = 0; R2 < w.length; R2++) {
              var b = c2(w[R2]);
              l3[b].references--;
            }
            for (var g = u2(I2, x2), E = 0; E < w.length; E++) {
              var T = c2(w[E]);
              l3[T].references === 0 && (l3[T].updater(), l3.splice(T, 1));
            }
            w = g;
          }
        };
...
`, ""]), t.exports = o3;
      ...
      t.exports = function(n) {
        ...
        return r.toString = function() {
          return this.map(function(a4) {
            var l3 = function(c2, u2) {
              var h3 = c2[1] || "", f = c2[3];
              if (!f)
                return h3;
              if (u2 && typeof btoa == "function") {
                var k = (v = f, A = btoa(unescape(encodeURIComponent(JSON.stringify(v)))), N = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(A), "/*# ".concat(N, " */")), p = f.sources.map(function(_2) {
                  return "/*# sourceURL=".concat(f.sourceRoot || "").concat(_2, " */");
                });
                return [h3].concat(p).concat([k]).join(`
`);
              }
              var v, A, N;
              return [h3].join(`
`);
            ...
            return a4[2] ? "@media ".concat(a4[2], " {").concat(l3, "}") : l3;
          }).join("");
        }, r.i = function(a4, l3, c2) {
          typeof a4 == "string" && (a4 = [[null, a4, ""]]);
          var u2 = {};
          if (c2)
            for (var h3 = 0; h3 < this.length; h3++) {
              var f = this[h3][0];
              f != null && (u2[f] = true);
            }
          for (var k = 0; k < a4.length; k++) {
            var p = [].concat(a4[k]);
            c2 && u2[p[0]] || (l3 && (p[2] ? p[2] = "".concat(l3, " and ").concat(p[2]) : p[2] = l3), r.push(p));
          }
        }, r;
      };
    }, function(t, o3, i2) {
      ...
      var a4 = function() {
        function l3(c2) {
          var u2 = c2.data, h3 = c2.config, f = c2.api, k = c2.readOnly;
          (function(p, v) {
            if (!(p instanceof v))
              throw new TypeError("Cannot call a class as a function");
          })(this, l3), this.api = f, this.readOnly = k, this._CSS = { block: this.api.styles.block, wrapper: "ce-paragraph" }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = h3.placeholder ? h3.placeholder : l3.DEFAULT_PLACEHOLDER, this._data = {}, this._element = null, this._preserveBlank = h3.preserveBlank !== void 0 && h3.preserveBlank, this.data = u2;
        }
        return r(l3, null, [{ key: "DEFAULT_PLACEHOLDER", get: function() {
          return "";
        } }]), r(l3, [{ key: "onKeyUp", value: function(c2) {
...
var Ke = class {
  ...
  constructor({ api: e }) {
    this.commandLink = "createLink", this.commandUnlink = "unlink", this.ENTER_KEY = 13, this.CSS = {
      ...
      button: null,
      input: null
    }, this.inputOpened = false, this.toolbar = e.toolbar, this.inlineToolbar = e.inlineToolbar, this.notifier = e.notifier, this.i18n = e.i18n, this.selection = new m2();
  }
  /**
   * Sanitizer Rule
   * Leave <a> tags
...
var Bt = (s2, e, t, o3) => {
  for (var i2 = o3 > 1 ? void 0 : o3 ? di(e, t) : e, n = s2.length - 1, r; n >= 0; n--)
    (r = s2[n]) && (i2 = (o3 ? r(e, t, i2) : r(i2)) || i2);
...
var St = class {
  ...
  handleClick() {
    ...
    const i2 = t.holder, n = o3.holder, r = i2.getBoundingClientRect(), a4 = n.getBoundingClientRect();
    let l3;
    a4.top > 0 ? l3 = Math.abs(r.top) - Math.abs(a4.top) : l3 = Math.abs(r.top) + a4.height, window.scrollBy(0, -1 * l3), this.api.blocks.move(e - 1), this.api.toolbar.toggleBlockSettings(true);
  }
};
St.isTune = true;
...
var fi = (s2, e, t, o3) => {
  for (var i2 = o3 > 1 ? void 0 : o3 ? pi(e, t) : e, n = s2.length - 1, r; n >= 0; n--)
    (r = s2[n]) && (i2 = (o3 ? r(e, t, i2) : r(i2)) || i2);
...
var bi = class extends C {
  ...
  backspacePressed(e) {
    ...
    if (o3.anyBlockSelected && !m2.isSelectionExists) {
  ...
  documentClicked(e) {
    if (!e.isTrusted)
      return;
    const t = e.target;
    this.nodes.holder.contains(t) || m2.isAtEditor || (this.Editor.BlockManager.dropPointer(), this.Editor.Toolbar.close());
    ...
    if (this.Editor.BlockSettings.opened && !r) {
      ...
      const a4 = this.Editor.BlockManager.getBlockByChildNode(t);
      this.Editor.Toolbar.moveAndOpen(a4);
    }
    this.Editor.BlockSelection.clearSelection(e);
  }
  /**
  ...
  redactorClicked(e) {
    ...
    if (d.isAnchor(i2) && n) {
      o3();
      const u2 = i2.getAttribute("href"), h3 = zt(u2);
      $t(h3);
      return;
    }
    const r = this.Editor.BlockManager.getBlockByIndex(-1), a4 = d.offset(r.holder).bottom, l3 = e.pageY;
    ...
    */
    a4 < l3) {
      o3();
      const { BlockManager: u2, Caret: h3, Toolbar: f } = this.Editor;
      (!u2.lastBlock.tool.isDefault || !u2.lastBlock.isEmpty) && u2.insertAtEnd(), h3.setToTheLastBlock(), f.moveAndOpen(u2.lastBlock);
    }
  }
  /**
   ...
   */
  selectionChanged() {
    const { CrossBlockSelection: e, BlockSelection: t } = this.Editor, o3 = m2.anchorElement;
    if (e.isCrossBlockSelectionStarted && t.anyBlockSelected && m2.get().removeAllRanges(), !o3) {
      m2.range || this.Editor.InlineToolbar.close();
      return;
    }
...
var ki = class {
  ...
  constructor(e) {
    ...
    this.isReady = new Promise((i2, n) => {
      ...
      const { BlockManager: i2, Caret: n, UI: r, ModificationsObserver: a4 } = this.moduleInstances;
      r.checkEmptiness(), a4.enable(), this.configuration.autofocus && (n.setToBlock(i2.blocks[0], n.positions.START), i2.highlightCurrentNode()), t();
    }).catch((i2) => {
  ...
  set configuration(e) {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : true, (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || false, (o3 = this.config.i18n) != null && o3.messages && $2.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i2 = this.config.i18n) == null ? void 0 : i2.direction) || "ltr";
  }
  /**
...
var vi = class {
  ...
  exportAPI(e) {
    ...
    t.forEach((n) => {
      ...
      Object.entries(r).forEach(([a4, l3]) => {
        this[l3] = e.moduleInstances.API.methods[n][a4];
      });
    });
  }
};
...
var d2 = class _d {
   ...
   */
  constructor({ data: t, config: e, api: r, readOnly: a4 }) {
    this.api = r, this.readOnly = a4, this.placeholder = this.api.i18n.t(e.placeholder || _d.DEFAULT_PLACEHOLDER), this.CSS = {
  ...
  tabHandler(t) {
    ...
    const e = t.target, r = t.shiftKey, a4 = e.selectionStart, s2 = e.value, n = "  ";
    let i2;
    if (!r)
      i2 = a4 + n.length, e.value = s2.substring(0, a4) + n + s2.substring(a4);
    else {
      const o3 = l(s2, a4);
      if (s2.substr(o3, n.length) !== n)
        return;
      e.value = s2.substring(0, o3) + s2.substring(o3 + n.length), i2 = a4 - n.length;
    }
...
var c = class {
  ...
  constructor({ data: e, config: t, api: s2, readOnly: r }) {
    this.api = s2, this.readOnly = r, this._CSS = {
  ...
  onPaste(e) {
    ...
    let s2 = this.defaultLevel.number;
    switch (t.tagName) {
      case "H1":
        s2 = 1;
        break;
    ...
    this._settings.levels && (s2 = this._settings.levels.reduce((r, n) => Math.abs(n - s2) < Math.abs(r - s2) ? n : r)), this.data = {
      level: s2,
      text: t.innerHTML
    };
  }
...
function M(E, a4 = null, i2 = {}) {
  const c2 = document.createElement(E);
  Array.isArray(a4) ? c2.classList.add(...a4) : a4 && c2.classList.add(a4);
  for (const r in i2)
    c2[r] = i2[r];
  return c2;
}
var j2 = class _j {
   ...
   */
  constructor({ api: a4, config: i2, onSelectFile: c2, readOnly: r }) {
    this.api = a4, this.config = i2, this.onSelectFile = c2, this.readOnly = r, this.nodes = {
   ...
   */
  render(a4) {
    return !a4.file || Object.keys(a4.file).length === 0 ? this.toggleStatus(_j.status.EMPTY) : this.toggleStatus(_j.status.UPLOADING), this.nodes.wrapper;
  }
  /**
   ...
   */
  createFileButton() {
    const a4 = M("div", [this.CSS.button]);
    return a4.innerHTML = this.config.buttonContent || `${L2} ${this.api.i18n.t("Select an Image")}`, a4.addEventListener("click", () => {
      this.onSelectFile();
    }), a4;
  }
  /**
   ...
   */
  showPreloader(a4) {
    this.nodes.imagePreloader.style.backgroundImage = `url(${a4})`, this.toggleStatus(_j.status.UPLOADING);
  }
  /**
   ...
   */
  fillImage(a4) {
    const i2 = /\.mp4$/.test(a4) ? "VIDEO" : "IMG", c2 = {
      src: a4
    };
    let r = "load";
    i2 === "VIDEO" && (c2.autoplay = true, c2.loop = true, c2.muted = true, c2.playsinline = true, r = "loadeddata"), this.nodes.imageEl = M(i2, this.CSS.imageEl, c2), this.nodes.imageEl.addEventListener(r, () => {
   ...
   */
  fillCaption(a4) {
    this.nodes.caption && (this.nodes.caption.innerHTML = a4);
  }
  /**
   * Changes UI status
   *
   ...
   */
  toggleStatus(a4) {
    for (const i2 in _j.status)
      Object.prototype.hasOwnProperty.call(_j.status, i2) && this.nodes.wrapper.classList.toggle(`${this.CSS.wrapper}--${_j.status[i2]}`, a4 === _j.status[i2]);
  }
  /**
   ...
   */
  applyTune(a4, i2) {
    this.nodes.wrapper.classList.toggle(`${this.CSS.wrapper}--${a4}`, i2);
  }
};
function x(E) {
  ...
  (function(i2, c2) {
    ...
    return function(i2) {
      ...
      function r(n) {
        if (c2[n])
          return c2[n].exports;
        var o3 = c2[n] = { i: n, l: false, exports: {} };
        return i2[n].call(o3.exports, o3, o3.exports, r), o3.l = true, o3.exports;
      }
      return r.m = i2, r.c = c2, r.d = function(n, o3, d5) {
        r.o(n, o3) || Object.defineProperty(n, o3, { enumerable: true, get: d5 });
      }, r.r = function(n) {
        typeof Symbol < "u" && Symbol.toStringTag && Object.defineProperty(n, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(n, "__esModule", { value: true });
      }, r.t = function(n, o3) {
        if (1 & o3 && (n = r(n)), 8 & o3 || 4 & o3 && typeof n == "object" && n && n.__esModule)
          return n;
        var d5 = /* @__PURE__ */ Object.create(null);
        if (r.r(d5), Object.defineProperty(d5, "default", { enumerable: true, value: n }), 2 & o3 && typeof n != "string")
          for (var b in n)
            r.d(d5, b, function(u2) {
              return n[u2];
            }.bind(null, b));
        return d5;
      }, r.n = function(n) {
        var o3 = n && n.__esModule ? function() {
          return n.default;
        } : function() {
          return n;
        };
        return r.d(o3, "a", o3), o3;
      }, r.o = function(n, o3) {
        return Object.prototype.hasOwnProperty.call(n, o3);
      }, r.p = "", r(r.s = 3);
    }([function(i2, c2) {
      var r;
      r = /* @__PURE__ */ function() {
      ...
      (function(n) {
        ...
        function f(e, l3) {
          ...
          e._state !== 0 ? (e._handled = true, u2._immediateFn(function() {
            var s2 = e._state === 1 ? l3.onFulfilled : l3.onRejected;
            if (s2 !== null) {
              var g;
              try {
                g = s2(e._value);
              } catch (m3) {
                return void y(l3.promise, m3);
              }
              p(l3.promise, g);
            } else
              (e._state === 1 ? p : y)(l3.promise, e._value);
        ...
        function p(e, l3) {
          try {
            ...
            if (l3 && (typeof l3 == "object" || typeof l3 == "function")) {
              var s2 = l3.then;
              if (l3 instanceof u2)
                return e._state = 3, e._value = l3, void w(e);
              if (typeof s2 == "function")
                return void t((g = s2, m3 = l3, function() {
                  g.apply(m3, arguments);
                }), e);
            }
            e._state = 1, e._value = l3, w(e);
          } catch (h3) {
            y(e, h3);
          }
          var g, m3;
        ...
        function y(e, l3) {
          e._state = 2, e._value = l3, w(e);
        }
        function w(e) {
          e._state === 2 && e._deferreds.length === 0 && u2._immediateFn(function() {
            e._handled || u2._unhandledRejectionFn(e._value);
          });
          for (var l3 = 0, s2 = e._deferreds.length; l3 < s2; l3++)
            f(e, e._deferreds[l3]);
          e._deferreds = null;
        }
        function v(e, l3, s2) {
          this.onFulfilled = typeof e == "function" ? e : null, this.onRejected = typeof l3 == "function" ? l3 : null, this.promise = s2;
        }
        function t(e, l3) {
          var s2 = false;
          try {
        ...
        u2.prototype.catch = function(e) {
          ...
          var s2 = new this.constructor(b);
          return f(this, new v(e, l3, s2)), s2;
        }, u2.prototype.finally = o3.a, u2.all = function(e) {
          return new u2(function(l3, s2) {
              ...
              try {
                if (C2 && (typeof C2 == "object" || typeof C2 == "function")) {
                  ...
                  if (typeof S == "function")
                    return void S.call(C2, function(O) {
                      h3(T, O);
                    }, s2);
                }
                g[T] = C2, --m3 == 0 && l3(g);
          ...
          return new u2(function(l3, s2) {
            for (var g = 0, m3 = e.length; g < m3; g++)
              e[g].then(l3, s2);
          });
        }, u2._immediateFn = typeof n == "function" && function(e) {
          n(e);
        } || function(e) {
          d5(e, 0);
      ...
      c2.a = function(n) {
        ...
        return this.then(function(d5) {
          return o3.resolve(n()).then(function() {
            return d5;
          });
        }, function(d5) {
          return o3.resolve(n()).then(function() {
      ...
      r(4);
      var o3, d5, b, u2, f, p, y, w = r(8), v = (d5 = function(t) {
        return new Promise(function(e, l3) {
          t = u2(t), (t = f(t)).beforeSend && t.beforeSend();
          var s2 = window.XMLHttpRequest ? new window.XMLHttpRequest() : new window.ActiveXObject("Microsoft.XMLHTTP");
          s2.open(t.method, t.url), s2.setRequestHeader("X-Requested-With", "XMLHttpRequest"), Object.keys(t.headers).forEach(function(m3) {
            var h3 = t.headers[m3];
            s2.setRequestHeader(m3, h3);
          });
          var g = t.ratio;
          s2.upload.addEventListener("progress", function(m3) {
            var h3 = Math.round(m3.loaded / m3.total * 100), k = Math.ceil(h3 * g / 100);
            t.progress(Math.min(k, 100));
          }, false), s2.addEventListener("progress", function(m3) {
            var h3 = Math.round(m3.loaded / m3.total * 100), k = Math.ceil(h3 * (100 - g) / 100) + g;
            t.progress(Math.min(k, 100));
            ...
            if (s2.readyState === 4) {
              ...
              var h3 = w.parseHeaders(s2.getAllResponseHeaders()), k = { body: m3, code: s2.status, headers: h3 };
              y(s2.status) ? e(k) : l3(k);
            }
          }, s2.send(t.data);
        });
      }, b = function(t) {
        ...
        if (t.headers = t.headers || {}, t.type && (typeof t.type != "string" || !Object.values(o3).includes(t.type)))
        ...
        switch (t.method) {
          ...
          case "UPDATE":
            ...
            (w.isFormData(t.data) || w.isFormElement(t.data)) && (l3 = o3.FORM), t.data = p(t.data, l3), l3 !== v.contentType.FORM && (t.headers["content-type"] = l3);
        }
        return t;
      }, p = function() {
        var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        ...
        return t >= 200 && t < 300;
      }, { contentType: o3 = { URLENCODED: "application/x-www-form-urlencoded; charset=utf-8", FORM: "multipart/form-data", JSON: "application/json; charset=utf-8" }, request: d5, get: function(t) {
        return t.method = "GET", d5(t);
      }, post: b, transport: function(t) {
        return t = u2(t), w.selectFiles(t).then(function(e) {
          for (var l3 = new FormData(), s2 = 0; s2 < e.length; s2++)
            l3.append(t.fieldName, e[s2], e[s2].name);
          w.isObject(t.data) && Object.keys(t.data).forEach(function(m3) {
            var h3 = t.data[m3];
            l3.append(m3, h3);
          });
          var g = t.beforeSend;
        ...
        return delete (t = u2(t)).beforeSend, w.selectFiles(t);
      } });
      i2.exports = v;
    }, function(i2, c2, r) {
      r.r(c2);
      ...
      (function(n) {
        var o3 = n !== void 0 && n || typeof self < "u" && self || window, d5 = Function.prototype.apply;
        function b(u2, f) {
          this._id = u2, this._clearFn = f;
        }
        c2.setTimeout = function() {
          return new b(d5.call(setTimeout, o3, arguments), clearTimeout);
        }, c2.setInterval = function() {
          return new b(d5.call(setInterval, o3, arguments), clearInterval);
        ...
        }, c2.enroll = function(u2, f) {
          clearTimeout(u2._idleTimeoutId), u2._idleTimeout = f;
          ...
          var f = u2._idleTimeout;
          f >= 0 && (u2._idleTimeoutId = setTimeout(function() {
            u2._onTimeout && u2._onTimeout();
          }, f));
        }, r(6), c2.setImmediate = typeof self < "u" && self.setImmediate || n !== void 0 && n.setImmediate || this && this.setImmediate, c2.clearImmediate = typeof self < "u" && self.clearImmediate || n !== void 0 && n.clearImmediate || this && this.clearImmediate;
      }).call(this, r(0));
    }, function(i2, c2, r) {
      (function(n, o3) {
        (function(d5, b) {
          if (!d5.setImmediate) {
            var u2, f, p, y, w, v = 1, t = {}, e = false, l3 = d5.document, s2 = Object.getPrototypeOf && Object.getPrototypeOf(d5);
            s2 = s2 && s2.setTimeout ? s2 : d5, {}.toString.call(d5.process) === "[object process]" ? u2 = function(h3) {
              o3.nextTick(function() {
                m3(h3);
              });
            } : function() {
              if (d5.postMessage && !d5.importScripts) {
                var h3 = true, k = d5.onmessage;
                return d5.onmessage = function() {
                  h3 = false;
                }, d5.postMessage("", "*"), d5.onmessage = k, h3;
              }
            }() ? (y = "setImmediate$" + Math.random() + "$", w = function(h3) {
              h3.source === d5 && typeof h3.data == "string" && h3.data.indexOf(y) === 0 && m3(+h3.data.slice(y.length));
            }, d5.addEventListener ? d5.addEventListener("message", w, false) : d5.attachEvent("onmessage", w), u2 = function(h3) {
              d5.postMessage(y + h3, "*");
            }) : d5.MessageChannel ? ((p = new MessageChannel()).port1.onmessage = function(h3) {
              m3(h3.data);
            }, u2 = function(h3) {
              p.port2.postMessage(h3);
            }) : l3 && "onreadystatechange" in l3.createElement("script") ? (f = l3.documentElement, u2 = function(h3) {
              var k = l3.createElement("script");
              k.onreadystatechange = function() {
                m3(h3), k.onreadystatechange = null, f.removeChild(k), k = null;
              }, f.appendChild(k);
            }) : u2 = function(h3) {
              setTimeout(m3, 0, h3);
            }, s2.setImmediate = function(h3) {
              typeof h3 != "function" && (h3 = new Function("" + h3));
              for (var k = new Array(arguments.length - 1), T = 0; T < k.length; T++)
                k[T] = arguments[T + 1];
              var C2 = { callback: h3, args: k };
              return t[v] = C2, u2(v), v++;
            }, s2.clearImmediate = g;
          }
          function g(h3) {
            delete t[h3];
      ...
      function u2(s2) {
        ...
        if ((r === d5 || !r) && setTimeout)
          return r = setTimeout, setTimeout(s2, 0);
        try {
          return r(s2, 0);
        } catch {
          try {
            return r.call(null, s2, 0);
          } catch {
            return r.call(this, s2, 0);
          }
        }
      }
      (function() {
        try {
          r = typeof setTimeout == "function" ? setTimeout : d5;
        } catch {
          r = d5;
        }
        try {
      ...
      function t() {
        if (!y) {
          ...
          f = null, y = false, function(m3) {
            if (n === clearTimeout)
              return clearTimeout(m3);
            if ((n === b || !n) && clearTimeout)
              return n = clearTimeout, clearTimeout(m3);
            try {
              n(m3);
            } catch {
              try {
                return n.call(null, m3);
              } catch {
                return n.call(this, m3);
              }
            }
          }(s2);
        }
      ...
      function e(s2, g) {
        this.fun = s2, this.array = g;
      }
      function l3() {
      }
      o3.nextTick = function(s2) {
        var g = new Array(arguments.length - 1);
        if (arguments.length > 1)
          for (var m3 = 1; m3 < arguments.length; m3++)
            g[m3 - 1] = arguments[m3];
        p.push(new e(s2, g)), p.length !== 1 || y || u2(t);
      }, e.prototype.run = function() {
        this.fun.apply(null, this.array);
      }, o3.title = "browser", o3.browser = true, o3.env = {}, o3.argv = [], o3.version = "", o3.versions = {}, o3.on = l3, o3.addListener = l3, o3.once = l3, o3.off = l3, o3.removeListener = l3, o3.removeAllListeners = l3, o3.emit = l3, o3.prependListener = l3, o3.prependOnceListener = l3, o3.listeners = function(s2) {
        return [];
      }, o3.binding = function(s2) {
        throw new Error("process.binding is not supported");
      }, o3.cwd = function() {
        return "/";
      }, o3.chdir = function(s2) {
      ...
      function n(d5, b) {
        for (var u2 = 0; u2 < b.length; u2++) {
          var f = b[u2];
          f.enumerable = f.enumerable || false, f.configurable = true, "value" in f && (f.writable = true), Object.defineProperty(d5, f.key, f);
        }
      }
      var o3 = r(9);
      i2.exports = function() {
        ...
        var b, u2, f;
        return b = d5, f = [{ key: "urlEncode", value: function(p) {
          return o3(p);
          ...
          return y.forEach(function(v) {
            var t = v.split(": "), e = t.shift(), l3 = t.join(": ");
            e && (w[e] = l3);
          }), w;
        } }], (u2 = null) && n(b.prototype, u2), f && n(b, f), d5;
      }();
    }, function(i2, c2) {
      var r = function(o3) {
        return encodeURIComponent(o3).replace(/[!'()*]/g, escape).replace(/%20/g, "+");
      }, n = function(o3, d5, b, u2) {
        return d5 = d5 || null, b = b || "&", u2 = u2 || null, o3 ? function(f) {
          for (var p = new Array(), y = 0; y < f.length; y++)
            f[y] && p.push(f[y]);
          return p;
        }(Object.keys(o3).map(function(f) {
          var p, y, w = f;
          if (u2 && (w = u2 + "[" + w + "]"), typeof o3[f] == "object" && o3[f] !== null)
            p = n(o3[f], null, b, w);
          else {
            d5 && (y = w, w = !isNaN(parseFloat(y)) && isFinite(y) ? d5 + Number(w) : w);
            var v = o3[f];
...
var B2 = class {
   ...
   */
  constructor({ config: a4, onUpload: i2, onError: c2 }) {
    this.config = a4, this.onUpload = i2, this.onError = c2;
  }
  /**
   ...
   */
  uploadSelectedFile({ onPreview: a4 }) {
    const i2 = function(r) {
      const n = new FileReader();
      n.readAsDataURL(r), n.onload = (o3) => {
        a4(o3.target.result);
      };
    };
    let c2;
    this.config.uploader && typeof this.config.uploader.uploadByFile == "function" ? c2 = F2.selectFiles({ accept: this.config.types }).then((r) => {
      i2(r[0]);
  ...
  uploadByUrl(a4) {
    let i2;
    this.config.uploader && typeof this.config.uploader.uploadByUrl == "function" ? (i2 = this.config.uploader.uploadByUrl(a4), _(i2) || console.warn("Custom uploader method uploadByUrl should return a Promise")) : i2 = F2.post({
      url: this.config.endpoints.byUrl,
      data: Object.assign({
        url: a4
      }, this.config.additionalRequestData),
      type: F2.contentType.JSON,
      headers: this.config.additionalRequestHeaders
   ...
   */
  uploadByFile(a4, { onPreview: i2 }) {
    const c2 = new FileReader();
    c2.readAsDataURL(a4), c2.onload = (n) => {
      i2(n.target.result);
    };
    let r;
    if (this.config.uploader && typeof this.config.uploader.uploadByFile == "function")
      r = this.config.uploader.uploadByFile(a4), _(r) || console.warn("Custom uploader method uploadByFile should return a Promise");
    else {
      const n = new FormData();
      n.append(this.config.field, a4), this.config.additionalRequestData && Object.keys(this.config.additionalRequestData).length && Object.entries(this.config.additionalRequestData).forEach(([o3, d5]) => {
        n.append(o3, d5);
      }), r = F2.post({
        url: this.config.endpoints.byFile,
        data: n,
...
var P2 = class _P {
   ...
   */
  constructor({ data: a4, config: i2, api: c2, readOnly: r, block: n }) {
    this.api = c2, this.readOnly = r, this.block = n, this.config = {
   ...
   */
  save() {
    const a4 = this.ui.nodes.caption;
    return this._data.caption = a4.innerHTML, this.data;
  }
  /**
   ...
   */
  renderSettings() {
    return _P.tunes.concat(this.config.actions).map((i2) => ({
      icon: i2.icon,
  ...
  async onPaste(a4) {
    switch (a4.type) {
      case "tag": {
        const i2 = a4.detail.data;
        if (/^blob:/.test(i2.src)) {
          const r = await (await fetch(i2.src)).blob();
          this.uploadFile(r);
          break;
        }
   ...
   */
  set data(a4) {
    this.image = a4.file, this._data.caption = a4.caption || "", this.ui.fillCaption(this._data.caption), _P.tunes.forEach(({ name: i2 }) => {
      const c2 = typeof a4[i2] < "u" ? a4[i2] === true || a4[i2] === "true" : false;
      this.setTune(i2, c2);
    });
  }
  /**
   ...
   */
  set image(a4) {
    this._data.file = a4 || {}, a4 && a4.url && this.ui.fillImage(a4.url);
  }
  /**
   ...
   */
  onUpload(a4) {
    a4.success && a4.file ? this.image = a4.file : this.uploadingFailed("incorrect response: " + JSON.stringify(a4));
  }
  /**
   ...
   */
  uploadingFailed(a4) {
    console.log("Image Tool: uploading failed because of", a4), this.api.notifier.show({
   ...
   */
  setTune(a4, i2) {
    this._data[a4] = i2, this.ui.applyTune(a4, i2), a4 === "stretched" && Promise.resolve().then(() => {
   ...
   */
  uploadUrl(a4) {
    this.ui.showPreloader(a4), this.uploader.uploadByUrl(a4);
  }
};
...
var d4 = class {
   ...
   */
  constructor({ data: e, config: t, api: r, readOnly: s2 }) {
    this._elements = {
      wrapper: null
    }, this.api = r, this.readOnly = s2, this.settings = [
      {
        name: "unordered",
  ...
  getOutofList(e) {
    ...
    if (t.length < 2)
      return;
    const r = t[t.length - 1], s2 = this.currentItem;
    s2 === r && !r.textContent.trim().length && (s2.parentElement.removeChild(s2), this.api.blocks.insert(), this.api.caret.setToBlock(this.api.blocks.getCurrentBlockIndex()), e.preventDefault(), e.stopPropagation());
  }
  /**
   * Handle backspace
   *
  ...
  selectItem(e) {
    e.preventDefault();
    const t = window.getSelection(), r = t.anchorNode.parentNode, s2 = r.closest("." + this.CSS.item), i2 = new Range();
    i2.selectNodeContents(s2), t.removeAllRanges(), t.addRange(i2);
  }
  /**
  ...
  pasteHandler(e) {
    ...
    if (t === "LI")
      ...
      s2.items = i2.map((n) => n.innerHTML).filter((n) => !!n.trim());
    }
    return s2;
  }
};
...
var s = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
var a3 = class _a {
  /**
   ...
   */
  constructor({ data: t, config: e, api: i2, readOnly: n }) {
    this.api = i2, this.readOnly = n, this._CSS = {
      block: this.api.styles.block,
      wrapper: "ce-paragraph"
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = e.placeholder ? e.placeholder : _a.DEFAULT_PLACEHOLDER, this._data = {}, this._element = null, this._preserveBlank = e.preserveBlank !== void 0 ? e.preserveBlank : false, this.data = t;
  }
  /**
...
function computeAutoPlacement(state, options) {
  ...
  return Object.keys(overflows).sort(function(a4, b) {
    return overflows[a4] - overflows[b];
  });
}
